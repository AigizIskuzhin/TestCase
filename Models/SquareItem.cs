...
namespace TestCase.Models
{
    ...
    {
        float Calculate(Cord P, Cord A, Cord B)
        {
        ...
        private bool IsPointInSquare(Cord point, IEnumerable<Cord> points)
        {
            ...
            var p1 = Calculate(point, array[0], array[1]);
            var p2 = Calculate(point, array[1], array[2]);
            var p3 = Calculate(point, array[2], array[3]);
            var p4 = Calculate(point, array[3], array[0]);
